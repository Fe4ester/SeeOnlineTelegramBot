...
📊 <b>Получить «диаграмму» активности</b>

Выберите пользователя (номер):

{tracked_list_str}

<i>Напишите <b>номер</b> пользователя, 
по которому хотите получить интервалы онлайна</i>
"""
...
<i>Напишите <b>номер</b> дня, по которому хотите получить интервалы онлайна</i>
"""

NO_TRACKING_DATA = (
    "Нет информации для получения графика, подождите немного и она появится"
)